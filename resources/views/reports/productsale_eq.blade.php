	...
	<table class="table table-bordered table-hover">
		<thead>
           <tr>
				...
				<td class="text-center" style="font-family:'Khmer Os System'" rowspan=2>ចំនួនលក់(ឯកតារាយ)</td>
				<td class="text-center" style="font-family:'Khmer Os System'" colspan=3>សរុបចំនួនលក់
				</td>
				<td class="text-center" style="font-family:'Khmer Os System'" rowspan=2>សរុប​ចំនួនថែម</td>
		...
		<tbody id="saleproductlist">
			...
			<tr style="background-color:#ddd;">
				...
				<td colspan=4 style="font-family:khmer os system;color:red;">សរុបចំនួនលក់ទាំងអស់</td>
				<td style="font-family:khmer os system;text-align:center;color:red;">{{ $lo }}</td>
				<td style="font-family:khmer os system;text-align:center;color:red;">{{ $y }}</td>
				<td style="font-family:khmer os system;text-align:center;color:red;">{{ $d }}</td>
				<td colspan=2></td>
			</tr>
		</tbody>
	</table>
