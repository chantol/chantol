...
<div class="table-responsive" style="overflow:auto;" id="printarea2">
	...
	<table class="table table-hover table-bordered" style="table-layout:auto;width:100%;">
		<thead>
           <tr>
				...
				<td class="text-center" style="font-family:'Khmer Os System'" rowspan=2>ស្តុករាយ</td>
