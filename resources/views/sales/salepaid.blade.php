...
@section('content')
	 ...
	 <div class="panel panel-default">
      <div class="panel-heading" style="background:blue;color:white;"><b>***Sale Payment</b></div>
					...
					<div class="col-lg-12">
						<div class="panel panel-body">
							...
							<div class="col-lg-2">
									...
									<button class="btn btn-info btnsearchbydate" style="margin-top:27px;size:45px;">Search by Date</button>
			    		...
			    		<div class="panel panel-default">
			    			<div class="panel-heading">
			    				...
			    				<div class="col-sm-2" style="margin-top:-2px;">
			    					<button id="btnprintall" class="btn btn-info btn-sm">Print all</button>
			    				</div>
			    				<div class="col-sm-6">
			    					<div class="custom-control custom-radio" style="float:right;display:inline;padding-left:5px;">
									...
									<div class="custom-control custom-radio" style="float:right;display:inline;">
...
//-------------------------------------------
			...
			$(document).on('click','#search_supplier',function(e){
				...
				var url="{{ route('saleinvoicesearchpaid') }}";
			...
			$(document).on('click','#search_lawfee',function(e){
				...
				var url="{{ route('saleinvoicesearchpaid') }}";
				$.get(url,{start_date:start_date,end_date:end_date,lawfee:lawfee,a:a,b:b},function(data){
					$("#table_data").empty().html(data);
					 //console.log(data)
				})
			})
			...
			$(document).on('click','#search_item',function(e){
				...
				var url="{{ route('saleinvoicesearchpaid') }}";
				$.get(url,{start_date:start_date,end_date:end_date,item:item,a:a,b:b},function(data){
					$("#table_data").empty().html(data);
					 //console.log(data)
				})
			})
...
//format number javascript
	...
	$(document).on('click','#btnprintall',function(e){
		...
		var redirectWindow = window.open(htp+'//'+htn+'/sale/invoice/printall?d1='+ d1 +'&d2='+d2+'&searchby='+sby+'&id='+id+'&a='+a+'&b='+b, '_blank');
