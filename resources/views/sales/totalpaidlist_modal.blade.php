<div class="modal fade" id="modal_saletotalpaidlist" role="dialog">
    <div class="modal-dialog modal-lg" style="width:1006px;">
      ...
      <div class="modal-content">
        ...
        <form action="#" id="frmsavesalepaidlist">
          <div class="modal-body">
            <input type="hidden" name="user_id" value="{{ Auth::id() }}">
            <div class="row">
              <div class="col-lg-4">
                  <label for="customer">Customer</label>
                  <input type="text" name="customerpaid" id="customerpaid" class="form-control" style="font-family:khmer os system;">
              </div>
              <div class="col-lg-4">
            ...
            <label for="Note">Payment Type</label>
